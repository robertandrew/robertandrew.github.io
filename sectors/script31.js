...
//			.attr('ry',(lh * 0.5))
		...
		barRectLabels.enter()
			...
			.attr('class',function(d){
				//Forces labels to flip when the number crosses the threshold
				var flipThreshold = scaleRect.domain()[1] * 0.6;				
				
				if(d.value > flipThreshold){
					return "innie";					
					}
				if(d.value < flipThreshold){
					return "outie";					
		...
		//Forcibly moves over the flipped labels
		d3.selectAll('g#barRectLabels text.innie')
