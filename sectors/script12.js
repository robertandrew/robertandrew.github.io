...
///////////////////////////////////		
	...
	function barrer(barDate){	
		...
		var scaleBarX = d3.scale.linear()
			...
			.domain([0,d3.max(barSet,function(d){return ab(d.pctChange)})]);
		...
		barRectRects
			...
			d3.select(this).transition()
				.duration(duration)
				.attr('width',function(d){return scaleBarX(ab(d.pctChange))});
			});//end each	
